...
import com.rickys.storyapp.database.RemoteKeys
import com.rickys.storyapp.database.StoryDatabase
import java.lang.Exception
import timber.log.Timber

@OptIn(ExperimentalPagingApi::class)
class StoryRemoteMediator(private val authToken: String, private val storyDatabase: StoryDatabase, private val apiService: ApiService) : RemoteMediator<Int, ListStoryItem>(){
    ...
    override suspend fun load(
        ...
        return try {
            val responseData = apiService.getAllStories(authToken, page, state.config.pageSize)
